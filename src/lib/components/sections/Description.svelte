<div>
  <h1 class="text-5xl font-semi-bold" data-aos="fade-up">Hi I'm Alvin</h1>
  <p class="text-gray-800 text-base my-2 font-normal" data-aos="fade-up">
    Javascript Developer
  </p>
  <p class="text-gray-600 text-sm font-thin" data-aos="fade-up">
